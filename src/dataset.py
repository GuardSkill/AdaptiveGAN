...
class Dataset(torch.utils.data.Dataset):
    ...
    def load_item(self, index):
        ...
        try:
            ...
            print("Can't load mask map. please check the file lists of mask in  directory ./datasets/...flist ")
        ...
        try:
            ...
            print("Can't load mask map. please check the file lists of mask in  directory ./datasets/mask_...flist ")
